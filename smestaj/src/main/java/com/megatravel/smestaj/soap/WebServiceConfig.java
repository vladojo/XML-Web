...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean(name = "units")
    public DefaultWsdl11Definition defaultWsdl11DefinitionUnits(XsdSchema unitsSchema) {
    ...
    @Bean(name = "unitsSchema")
    public XsdSchema unitsSchema() {
        return new SimpleXsdSchema(new ClassPathResource("units.xsd"));
    }
